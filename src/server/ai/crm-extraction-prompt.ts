...
- Skip a row by returning record=null when it has neither an email nor a mobile number. Give a short skip_reason. Otherwise return record and an empty skip_reason.
